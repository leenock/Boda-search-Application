...
if(isset($_POST['Submit'])){
	...
	$con=mysql_select_db('bodaichecksystem',$connect)or die(mysql_error());
	 ...
	 $query= "SELECT *from operators_personal_acc WHERE Boda_plate_number='".$_POST['platenumber']."' AND  Email_Address='".$_POST['Email']."' AND Phonenumber='".$_POST['telenumber']."' AND National_Id='".$_POST['IDnumber']."' ";
	
	                     $result=mysql_query($query)or die(mysql_error());
						 $Numrows=mysql_num_rows($result);	
				 if($Numrows>0)
                     {
								 echo" <script>alert('Already a registered User')</script>";
					 }
					 else
					 {
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
								...
								<li><a href="#"><i class="menu-icon icon-file"></i>Manage Accounts</a></li>
                                <li><a href="#"><i class="menu-icon icon-download"></i>Generate Report</a></li>
                                <li><a href="#"><i class="menu-icon icon-file"></i>Reported Cases</a></li>
								<li><a href="#"><i class="menu-icon icon-download"></i>Forward Reported Cases</a></li>
								<li><a href="reportcase.php"><i class="menu-icon icon-file"></i>Report Case</a></li>
								<li><a href="reportcase.php"><i class="menu-icon icon-file"></i>Report Case</a></li>
                         ...
                         <div class="module-option clearfix">
                                    <div class="pull-left">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="createLibrarianAcc.php">Add Acoounts</a></li>
                                                <li><a href="#">Report Case</a></li>
							    ...
							    <div class="pull-right">
                                   ...
                                   <form class="form-horizontal row-fluid" method="Post"     enctype="multipart/form-data">
                                    ...
                                    <input type="text"  class="w8em format-d-m-y highlight-days-67 range-high-today span4 tip" name="dob" id="sd" placeholder="date of birth" maxlength="10"  required/>
                                     <a id="fd-but-sd" title="" class="date-picker-control" href=""><span>sel</span></a>
									...
									<div class="jumbotron">
                                     ...
                                     <div class="controls">
                                     <input type="text"    name="referencenumber" class="span3 tip" autofocus required>
