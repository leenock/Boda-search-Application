...
function clean($str){
	...
	$operation_route	=  clean($_POST['operation_route']);
...
$sql="INSERT INTO operators_personal_acc(`Firstname`, `Lastname`, `Surname`, `Phonenumber`, `Emergency_number`, `National_Id`, `Gender`, `DOB`, `Place_of_birth`, `operation_route`, `Hometown`, `County`, `Nationa_id_image`, `Insuarance_cover`, `Driving_licence`, `Boda_ownwership_certificate`, `Passport_picture`, `Operators_reference_id`, `Boda_plate_number`, `Email_Address`, `Account_status`) Values ('".$fullname."', '".$lastname."', '".$surname."', '".$phonenumber."', '".$emergencynum."', '".$nationalId."', '".$gender."', '".$dob."', '".$plceofbirth."', '".$operation_route."', '".$hometown."', '".$county."', '".$nationalIdpic."', '".$insuarancecover."', '".$drivinglicence."', '".$ownershipcert."', '".$passportpic."', '".$referencenumber."', '".$bodaplatenumber."', '".$emailaddress."', '".$status."')";
							    ...
							    <div class="pull-right">
                                   ...
                                   <form class="form-horizontal row-fluid" method="Post"     enctype="multipart/form-data">
                                    <div class="module-body">
                                        ...
                                        <div class="controls">
                                                <input type="text" placeholder="First Name" autocomplete="off" name="firstname" class="span4 tip" pattern="[A-Za-z]{3,10}"  title="Only Alphabets" required>
                                                <input type="text" placeholder="last Name " autocomplete="off" name="lastname" class="span4 tip" pattern="[A-Za-z]{3,10}"  title="Only Alphabets" required>
                                                <input type="text" placeholder="surName " autocomplete="off" name="surname" class="span4 tip" pattern="[A-Za-z]{3,10}"  title="Only Alphabets" required>
                                        </div>
                                        </div>
                                        ...
                                        <div class="controls">
                                                <input type="text" placeholder="Phone Number" autocomplete="off" maxlength="10" name="telenumber" class="span4 tip" onkeypress="return validateKeyStrokes(event)" title="Only Numbers" required>
                                                <input type="text" placeholder="Emergency Number" autocomplete="off" maxlength="10" name="emergencynum" class="span4 tip" onkeypress="return validateKeyStrokes(event)" title="Only Numbers" required>
                                                <input type="text"  placeholder="National ID" maxlength="8" name="IDnumber" class="span4 tip" autocomplete="off" onkeypress="return validateKeyStrokes(event)" title="Only Numbers" required>
                                    ...
                                    <input type="text"  class="w8em format-d-m-y highlight-days-67 range-high-today span4 tip" name="dob" id="sd" placeholder="date of birth" maxlength="10" autocomplete="off"  required/>
                                     <a id="fd-but-sd" title="" class="date-picker-control" href=""><i class="fa fa-calendar"></i><span>sel</span></a>
									<input type="text" placeholder="Place of Birth" name="birthplace" class="span4 tip" pattern="[A-Za-z]{3,10}"  autocomplete="off" title="Only Alphabets" required>
                                     </div>
                                     </div>
                                   
                                       <br/>
                                    <div class="control-group">
                                    <label class="control-label">Operation route</label>
									
                                    <div class="controls">
                                                <input type="text" placeholder="operation route" autocomplete="off" name="operation_route" class="span4 tip" required>
                                                <input type="text" placeholder="Home Town" name="Hometwon" class="span4 tip" pattern="[A-Za-z]{3,6}"  title="Only Alphabets" autocomplete="off" required>
									...
									<div class="jumbotron">
									 ...
									 <input type="text"  placeholder="Boda PlateNumber (KXX-212Z)" name="platenumber" class="span3 tip" autocomplete="off" required>
									 <input type="email"  placeholder="Email Address" name="Email" type="email" class="span4 tip" autocomplete="off"  required>
                                     </div>
                                     </div> 
<hr>
