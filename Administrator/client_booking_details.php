                        ...
                        <div class="content" style="width:146%">
                         ...
                         <div class="module-option clearfix">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
											   <li><a href="dashboard.php"><i class="menu-icon icon-dashboard" ></i>Dash board</a></li>  
												...
												<li><a href="file_printClientbooking_details.php"><i class="menu-icon icon-file" ></i>Export pdf</a></li>
							    ...
							    <div class="pull-right">
                                        <button onclick="myFunction()" class="btn btn-light">Refresh Page</button>
										 <a href="file_printClientbooking_details.php" button onclick="myFunction()" class="btn btn-light">print</a>
                                    </div>
                                </div>
								 ...
								 <?php $user_query=mysql_query("select * from save_ride")or die(mysql_error());
								  while($row=mysql_fetch_array($user_query)){
								  
								  $id=$row['Count_id']; ?>
								  <tr class="del<?php echo $id ?> success">
								   <td><?php echo $row['Count_id']; ?></td> 
								  <td><?php echo $row['Client_mobilenumber']; ?></td>
								  <td><?php echo $row['boda_operatorName']; ?></td>			 
								  <td><?php echo $row['boda_plate_Number']; ?></td>
								  <td><?php echo $row['County']; ?></td>
								  <td><?php echo $row['entry_timestamp']; ?></td>
