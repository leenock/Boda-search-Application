                        ...
                        <div class="content" style="width:146%">
                         ...
                         <div class="module-option clearfix">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
											   <li><a href="dashboard.php"><i class="menu-icon icon-dashboard" ></i>Dash board</a></li>  
												...
												<li><a href="file_printclients_Accounts.php"><i class="menu-icon icon-file" ></i>Export pdf</a></li>
							    ...
							    <div class="pull-right">
								 ...
								 <?php $user_query=mysql_query("select * from client_personal_acc")or die(mysql_error());
								  while($row=mysql_fetch_array($user_query)){
								  
								  $id=$row['id']; ?>
								  <tr class="del<?php echo $id ?> success">
								   <td><?php echo $row['id']; ?></td>
								  <td><?php echo $row['First_name']." ".$row['Last_name']." ".$row['surname']; ?></td>
								  ...
								  <td><a href="<?php echo "../ClientWebApp/".$row['profile_pic']; ?>"><img src="<?php echo "../ClientWebApp/".$row['profile_pic']; ?>" class="img-thumbnail" alt="Photo" width="70" height="70"></a></td>
								   <td> <span class="label label-sm label-info"><?php echo $row['Account_status']; ?></span></td>
								   <td>
								  <button class="btn btn-xs btn-success" title="edit user"><i class="icon-edit" ></i>
							      <button class="btn btn-xs btn-danger" title="delete user"><i class="icon-trash"></i></button>
								  <button class="btn btn-xs btn-info" title="view profile"><i class="icon-user"></i></button>
								  </td>
